...
function addPhotoToUI(photo) {
    ...
    console.log('사진 추가 중:', photo.caption, '컨테이너:', photoList);
    ...
    photoCard.innerHTML = `
        <div class="photo-placeholder">
            <img src="data:image/svg+xml;base64," 
                  ...
                  onerror="this.style.display='none'; this.parentElement.innerHTML='${photo.caption || '사진을 불러올 수 없습니다'}';">
        </div>
        ${photo.caption ? `<div class="photo-caption">${photo.caption}</div>` : ''}
        <div class="photo-info">
            <small>${photo.uploader_name || '익명'} • ${formattedDate}</small>
        </div>
    `;
    
    try {
        // 사진 목록 맨 위에 추가 (기존 방식과 동일)
        photoList.insertBefore(photoCard, photoList.firstChild);
        console.log('사진 추가 완료:', photo.caption);
